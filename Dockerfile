...
RUN wget -qO- https://dl.bintray.com/boostorg/release/1.72.0/source/boost_1_72_0.tar.gz | tar xzf - -C /usr/src/ && \
    mv /usr/src/boost* /usr/src/boost-git
RUN git clone -b libtorrent-1_2_5 https://github.com/arvidn/libtorrent.git /usr/src/libtorrent-git
RUN git clone -b release-4.2.2 https://github.com/qbittorrent/qBittorrent.git /usr/src/qbittorrent-git
